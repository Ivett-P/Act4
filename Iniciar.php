                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">¡Regresaste!</h1>
                                    </div>
                                    <form method="POST" action="index.php">
                                        <form class="user">
                                            ...
                                            <div class="form-group">
                                                <input type="email" class="form-control form-control-user" name="email" aria-describedby="emailHelp" placeholder="Correo Eléctronico">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="Registro.php">¿Aún no tiene una cuenta?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
